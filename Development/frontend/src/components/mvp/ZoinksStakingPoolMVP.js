...
import { ZoinksStakingPoolAddress, ZoinksTokenAddress } from "./../addresses.js";
import TransactionInfo from "./../common/TransactionInfo.js";
import BlockchainUtils from "./../common/BlockchainUtils.js";

class ZoinksStakingPoolMVP extends Component {
        ...
        return (
            <>
                ...
                <form className="form" action="#" onSubmit={async (event) => {
                    ...
                    const sender = ZoinksStakingPoolAddress;
                    await this.utilsZoinks.methodSend("approve", sender, _amount);
...
export default ZoinksStakingPoolMVP;