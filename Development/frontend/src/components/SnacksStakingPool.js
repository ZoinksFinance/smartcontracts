...
import { SnacksStakingPoolAddress } from "./addresses.js";
...
class SnacksStakingPool extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            rewardEthSnacksToken: null, // Proof of concept
            rewardBtcSnacksToken: null, // Proof of concept
            stakedToken: null, // Proof of concept
            seniorageAddress: null, // Proof of concept
            totalStakedSnacks: null, // Proof of concept
            totalRewardDebtSnacks: null, // Proof of concept
            totalRewardDebtEthSnacks: null, // Proof of concept
            totalRewardDebtBtcSnacks: null, // Proof of concept
    ...
    async readProps(method) {
        try {
            ...
            const allProps = {
                ...
                rewardEthSnacksToken: await this.state.contract.rewardEthSnacksToken(),
                rewardBtcSnacksToken: await this.state.contract.rewardBtcSnacksToken(),
            ...
            this.setState({
                ...
                rewardEthSnacksToken: allProps.rewardEthSnacksToken.toString(),
                rewardBtcSnacksToken: allProps.rewardBtcSnacksToken.toString(),
            ...
            <>
                <div className="container">
                    ...
                    <div className="propsContainer">
                        ...
                        <p>rewardEthSnacksToken</p>
                        <p><span>{this.state.rewardEthSnacksToken ?? "Empty"}</span></p>
                        <p>rewardBtcSnacksToken</p>
                        <p><span>{this.state.rewardBtcSnacksToken ?? "Empty"}</span></p>
                        <p>stakedToken</p>
                    ...
                    <div className="methods">
                        ...
                        <form className="form" action="#" onSubmit={(event) => {
                            ...
                            const _rewardEthSnacksToken = event.target._rewardEthSnacksToken.value;
                            const _rewardBtcSnacksToken = event.target._rewardBtcSnacksToken.value;
                            const _poolLimitPerUser = event.target._poolLimitPerUser.value;
                            const _admin = event.target._admin.value;
                            this.utils.methodSend("initialize", _stakedToken, _rewardToken, _rewardEthSnacksToken, _rewardBtcSnacksToken, _poolLimitPerUser, _admin);
                        }}>
                            <h3>initialize</h3>
                            ...
                            <label><strong>IBEP20 _rewardEthSnacksToken</strong></label>
                            <input type="text" name="_rewardEthSnacksToken" placeholder="Input reward eth snacks token" /><br />

                            <label><strong>IBEP20 _rewardBtcSnacksToken</strong></label>
                            <input type="text" name="_rewardBtcSnacksToken" placeholder="Input reward btc snacks token" /><br />
...
export default SnacksStakingPool;